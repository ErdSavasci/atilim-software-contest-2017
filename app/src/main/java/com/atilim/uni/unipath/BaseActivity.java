...
public class BaseActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_exit) {
            ...
            mapsIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            ...
            editor.putString("LOGCAT_TEXTVIEW_TEXT", logcatTextView.getTextView().getText().toString());
            editor.apply();
