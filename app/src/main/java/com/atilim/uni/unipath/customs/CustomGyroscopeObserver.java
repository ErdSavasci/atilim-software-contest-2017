...
public class CustomGyroscopeObserver implements SensorEventListener {
    ...
    private LinkedList<CustomPanoramaImageView> mViews = new LinkedList<>();
    ...
    void addPanoramaImageView(CustomPanoramaImageView view) {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (rotateY > rotateX + rotateZ) {
            ...
            if (mRotateRadianY > mMaxRotateRadian) {
                ...
                for (CustomPanoramaImageView view: mViews) {
