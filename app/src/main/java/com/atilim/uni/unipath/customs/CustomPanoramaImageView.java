...
/**
 * Created by erd_9 on 16.04.2017. (Original Work by gjz)
 */

public class CustomPanoramaImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    //The canvas of drawable
    private Canvas canvas;

    // Observe scroll state
    private CustomPanoramaImageView.OnPanoramaScrollListener mOnPanoramaScrollListener;
    ...
    public CustomPanoramaImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setGyroscopeObserver(CustomGyroscopeObserver observer) {
        if (observer != null) {
    ...
    public interface OnPanoramaScrollListener {
         ...
         */
        void onScrolled(CustomPanoramaImageView view, float offsetProgress);
    }

    public void setOnPanoramaScrollListener(CustomPanoramaImageView.OnPanoramaScrollListener listener) {
